...
public class Pongspiel {
    ...
    public void spiele() throws InterruptedException {
        ...
        while (true){
            ...
            ib.neuerText(spielfeld.getSpielfeldBreite()/2+11, spielfeld.getMargin()+12, Integer.toString(spielerLinks.getPunkte()));
            ib.neuerText(spielfeld.getSpielfeldBreite()/2 + 22, spielfeld.getMargin()+12, Integer.toString(spielerRechts.getPunkte()));
